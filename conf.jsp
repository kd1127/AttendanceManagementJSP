	...
	<body>
		...
		<form action="../servlet/admin.ConfAction" method="post">
			<table class="conftbl">	<!-- cssを変更 -->
				<tr>
					<td>講座番号</td>
					<td><div><jsp:getProperty property="anumber" name="bn"/></div></td>
				</tr>
				<tr>
					<td>講座名</td>
					<td><div><jsp:getProperty property="aname" name="bn"/></div></td>
				</tr>
				<tr>
					<td>講座開催日</td>
					<td>
				...
				<tr>
					<td>開始時刻</td>
					<td>
						<span class="fontcolor"><jsp:getProperty property="sthour" name="bn"/></span>時
						<span class="fontcolor"><jsp:getProperty property="stminute" name="bn"/></span>分
					</td>
				</tr>
				<tr>
					<td>終了時刻</td>
					<td>
						<span class="fontcolor"><jsp:getProperty property="endhour" name="bn"/></span>時
						<span class="fontcolor"><jsp:getProperty property="endminute" name="bn"/></span>分
					</td>
				</tr>
				<tr>
					<td>定員</td>
					<td><span class="fontcolor"><jsp:getProperty property="capacity" name="bn"/></span>人</td>
				</tr>
			</table>
			<div>
